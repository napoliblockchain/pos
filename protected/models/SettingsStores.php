...
/**
 * This is the model class for table "np_settings_stores".
 *
 * The followings are the available columns in table 'np_settings_stores':
 * @property integer $id_setting
 * @property integer $id_store
 * @property string $setting_name
 * @property string $setting_value
 */
class SettingsStores extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_store, setting_name, setting_value', 'required'),
			...
			array('id_setting, id_store, setting_name, setting_value', 'safe', 'on'=>'search'),
		);
	}
