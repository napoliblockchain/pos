...
<head>
    ...
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/BRTP.css" rel="stylesheet" media="all" >

    <!-- QRCODE CSS -->
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/qrcode.css" rel="stylesheet" media="all">
...
<?php
//include ('js_backend.php');  // backend
//include ('js_sw.php');  // service worker
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/src/js/countdown/jquery.countdown.js', CClientScript::POS_END);
?>
